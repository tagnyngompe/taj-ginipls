...
def lsa_learn_transformation(X_train, n_components=10, n_iter=10):
...
def latentDA_learn_transformation(X_train, n_components=10, max_iter=100):
    """
...
def sklearn_pls_canonical_train(X_train, y_train, n_components=10):
...
def sklearn_pls_regression_train(X_train, y_train, n_components=10):
    if n_components > np.asarray(X_train).shape[1]:
        n_components = np.asarray(X_train).shape[1]-1
